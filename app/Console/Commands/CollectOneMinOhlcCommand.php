...
//        }
        ...
        OhlcOneMinCollected::dispatch('ALL', now()->toTimeString());
    ...
    private function processInstrument( array $inst, string $token ): void
    {
        ...
        // ── 1. Load expiries (same as CollectLiveOhlcCommand) ──────────────────
        ...
        // ── 2. Load CE/PE + FUT instrument keys (same as CollectLiveOhlcCommand) ─
        ...
        // ── 3. Call /market-quote/ohlc with interval=1minute ───────────────────
        ...
        // ── 4. Build rows and upsert into ohlc_quotes ──────────────────────────
        $now  = now()->second( 0 );
        $rows = [];
        ...
        foreach ( $quotes as $instrumentKey => $quote ) {
            ...
            // Align timestamp to current minute boundary
    ...
    {
        // /market-quote/ohlc supports up to 500 keys per request
