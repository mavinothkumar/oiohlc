...
class GenerateDailyStrategies extends Command {
    ...
    public function handle() {
        ...
        $strategies = [
            ...
            [
                'name' => 'Daily IAO',
                'legs' => array_values( $this->consolidateLegs( $rawIaoLegs ) ),
            ],
            [
                'name' => 'Daily IAO OTM',
                'legs' => array_values( $this->consolidateLegs( $rawIaoLegsOTM ) ),
            ],
            [
                'name' => 'Daily ITM',
                'legs' => [
    ...
    private function consolidateLegs( $rawIaoLegs ) {
        $consolidatedIaoLegs = [];
