...
{{--                                    >--}}
            ...
            <div class="flex justify-end gap-3">
                ...
                @if ($isEdit)
                    <button
                        type="button"
                        onclick="document.getElementById('clone-strategy-form').submit()"
                        class="inline-flex items-center gap-1.5 rounded-lg border border-indigo-300 bg-indigo-50 px-5 py-2.5 text-sm font-semibold text-indigo-700 hover:bg-indigo-100 transition shadow-sm"
                    >
                ...
                <button
                    type="submit"
                    class="rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 shadow-sm"
                >
        ...
        @if ($isEdit)
            <form id="clone-strategy-form" method="POST" action="{{ route('backtest.strategies.clone', $strategy->id) }}" class="hidden">
                @csrf
            </form>
        @endif
    </div>
