                    ...
                    @forelse($grouped as $contracts)
                        @foreach($contracts as $index => $row)
                            ...
                            <tr class="border-b last:border-b-0 hover:bg-slate-50">
                                ...
                                {{-- OPT LTP (no dots now, just value) --}}
                                ...
                                {{-- High with dot if CE/PE LTP near HIGH --}}
                                <td class="px-3 py-2">
                                    <span class="inline-flex items-center gap-1">
                                        @if($isCe && $row['ce_near_high'])
                                            <span class="inline-block h-2 w-2 rounded-full bg-red-500"></span>
                                        @elseif($isPe && $row['pe_near_high'])
                                ...
                                <td class="px-3 py-2">
                                    <span class="inline-flex items-center gap-1">
                                        @if($isCe && $row['ce_near_low'])
                                            <span class="inline-block h-2 w-2 rounded-full bg-red-500"></span>
                                        @elseif($isPe && $row['pe_near_low'])
                                            <span class="inline-block h-2 w-2 rounded-full bg-green-500"></span>
                                        @endif
                                ...
                                <td class="px-3 py-2 font-semibold">
                                    <span class="inline-flex items-center gap-1">
                                        @if($isCe && $row['ce_near_close'])
                                            <span class="inline-block h-2 w-2 rounded-full bg-red-500"></span>
                                        @elseif($isPe && $row['pe_near_close'])
                                            <span class="inline-block h-2 w-2 rounded-full bg-green-500"></span>
                                        @endif
